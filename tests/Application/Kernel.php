...
namespace Tests\Nextstore\SyliusLiveModulePlugin\Application;
...
final class Kernel extends BaseKernel
{
    ...
    protected function getContainerBaseClass(): string
    {
        if (
            ...
            class_exists(MockerContainer::class)
        ) {
    ...
    private function getConfigurationDirectories(): iterable
    {
        ...
        $syliusConfigDir =
            $this->getProjectDir() .
            "/config/sylius/" .
            SyliusKernel::MAJOR_VERSION .
            "." .
            SyliusKernel::MINOR_VERSION;
        ...
        $symfonyConfigDir =
            $this->getProjectDir() .
            "/config/symfony/" .
            BaseKernel::MAJOR_VERSION .
            "." .
            BaseKernel::MINOR_VERSION;
