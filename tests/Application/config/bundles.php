...
return [
    ...
    Sylius\Bundle\AttributeBundle\SyliusAttributeBundle::class => [
        "all" => true,
    ],
    ...
    Sylius\Bundle\PromotionBundle\SyliusPromotionBundle::class => [
        "all" => true,
    ],
    Sylius\Bundle\AddressingBundle\SyliusAddressingBundle::class => [
        "all" => true,
    ],
    Sylius\Bundle\InventoryBundle\SyliusInventoryBundle::class => [
        "all" => true,
    ],
    ...
    Nextstore\SyliusLiveModulePlugin\NextstoreSyliusLiveModulePlugin::class => [
        "all" => true,
    ],
    ...
    SyliusLabs\Polyfill\Symfony\Security\Bundle\SyliusLabsPolyfillSymfonySecurityBundle::class => [
        "all" => true,
    ],
